...
var c = new Crawler({
  ...
  callback: function(error, res, done) {
    ...
    if (error) {
      ...
      fs.writeFile("./a.txt", res.body, function (err) {
          if (err) {
